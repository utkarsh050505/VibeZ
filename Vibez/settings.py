...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'Vibez/static')]
...
EMAIL_HOST_USER = 'vibezconnect610@gmail.com'
EMAIL_HOST_PASSWORD = 'kxqxwmmlhixnswsh'  # App password from Google
